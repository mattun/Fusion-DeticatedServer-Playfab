...
namespace Fusion.Sample.DedicatedServer {
  ...
  public class ClientManager : MonoBehaviour, INetworkRunnerCallbacks {
    ...
    void OnGUI() {
      Rect area = new Rect(10, 120, Screen.width - 20, Screen.height - 140);
    ...
    public Task<StartGameResult> StartSimulation(
      ...
      Debug.Log("ClientManager StartSimulation");
      Debug.Log(((int)SceneDefs.CLIENTGAME).ToString());
    ...
    public void OnShutdown(NetworkRunner runner, ShutdownReason shutdownReason) {
      ...
      if (Application.isPlaying) {
        SceneManager.LoadScene((byte)SceneDefs.CLIENTMENU);
      }
    }
